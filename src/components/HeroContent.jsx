...
function HeroContent() {
    ...
    const handleGitHubClick = () => {
        toast.success("GitHub profili açılıyor!", {
            autoClose: 3000,
        })
    }
    const handleLinkedinClick = () => {
        toast.success("LinkedIn profili açılıyor!", {
            autoClose: 3000,
        })
    }

    return (
        <div className="flex justify-center items-center w-full px-4 sm:ml-10 sm:flex-1 sm:-mt-10 md:flex-row md:justify-between md:items-center md:-mt-20 lg:w-[960px] xl:w-[70rem] xl:justify-around 2xl:w-[80rem]  ">
