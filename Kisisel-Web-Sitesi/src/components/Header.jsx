...
function Header() {
  ...
  return (
    <div className="flex items-center justify-between w-full mt-12 xl:w-[890px] xl:mx-auto sm:flex sm:flex-col-reverse  md:ml-0 md:flex-row md:max-w-[85%] ">

      <h4 className="font-inter text-[32px] font-bold text-customGreen  sm:text-wrap sm:mb-6 md:ml-0 ">
        melisa
      </h4>

      <div className="flex items-center gap-8 sm:mb-4 sm:gap-56  md:gap-6 lg:gap-6 xl:gap-4 2xl:gap-1 2xl:-mr-2">
        <h4 className="font-inter text-[15px] tracking-[0.1em] text-customGreen whitespace-nowrap -mt-10  xl:mr-4 z-10 ">
          {language === 'en' ? (
            <span
